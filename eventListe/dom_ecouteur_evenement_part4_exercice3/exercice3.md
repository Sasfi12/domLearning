...
### 3. Trouve une methode qui rajoute la class text-style sur le paragraphe mais 
### 3.1 qui en meme temps vérifie si la class est déjà dessus, dans ce cas la cette methode est capable de la retirer 
